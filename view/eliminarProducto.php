...
<body>
  <section>
    <div class="container">
      <div class="row">
        <div class="col-12">
          <h3 class="text-center">Resumen de producto a <b>ELIMINAR</b></h3>
        </div>
      </div>
      <div class="row justify-content-around ">
        <div class="col-sm-12 col-xs-12 col-md-12">
          ...
          <form action="../controller/ControllerEliminarProd.php" method="POST">
          ...
          <button class="btn btn-lg btn-danger btn-block"  style="height:60px; display: flex; align-items: center; justify-content: center;margin-top: 55px;" type="submit">
          <p> ELIMINAR</p>
          </button>
          </form>
